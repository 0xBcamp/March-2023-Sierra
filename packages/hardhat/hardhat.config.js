...
module.exports = {
  ...
  networks: {
    ...
    sepolia: {
      url: "https://eth-sepolia.g.alchemy.com/v2/R7tVsoiJuSujym_uh6GhcTbilvWzVUg7", // <---- YOUR INFURA ID! (or it won't work)
    ...
    polygonMumbai: {
      url: "https://polygon-mumbai.g.alchemy.com/v2/O-UenFDcMiAqh8z7O8SYehuPqWTH0-Ph", //"https://rpc-mumbai.maticvigil.com", //  process.env.MUMBAI_RPC_URL, <---- YOUR MORALIS ID! (not limited to infura)
      //gasPrice: 1000000000,
      accounts: {
        mnemonic: mnemonic(),
      },
